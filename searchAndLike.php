...
<head>
          ...
          <title>Class Based Site :: Search with WHERE LIKE AND LIKE</title>
...
<div class="container">
    ...
    <div class="row">
    <div class="col-md-12">
   	<h1>Search with WHERE LIKE AND LIKE</h1>
 ...
 <form method="get" class="form-inline">
   ...
   <input type="text" name="filmDescription" value="<?php echo $sFilmDescription;?>" class="form-control">
   </label>
