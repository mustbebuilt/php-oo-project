...
$success = $db->insert("movies", array('filmName', 'filmDescription', 'filmImage', 'filmPrice', 'filmReview'), array($sFilmName, $sFilmDesc, $sFilmImage, $sFilmPrice, $sFilmReview),array('s','s','s','s','i'));
// then redirect
